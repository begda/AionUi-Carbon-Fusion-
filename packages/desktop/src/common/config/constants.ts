...
/**
 * CarbonFusion应用程序共用常量
 */

// ===== 文件处理相关常量 =====

/** 临时文件时间戳分隔符 */
export const CARBONFUSION_TIMESTAMP_SEPARATOR = '_carbonfusion_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const CARBONFUSION_TIMESTAMP_REGEX = /_carbonfusion_\d{13}(\.\w+)?$/;
export const CARBONFUSION_FILES_MARKER = '[[CARBON_FILES]]';
